...
export class NavService implements OnDestroy {
	...
	MENUITEMS: Menu[] = [
		{
			headTitle1: 'MEDICARE', headTitle2: 'No1 Ecommerce App',
		},
		// {
		// 	title: 'Categories', icon: 'home', type: 'sub', badgeType: 'success', badgeValue: '2', active: true, children: [
		// 		{ path: '/sample-page', title: 'Sample 1', type: 'link' },
		// 		{ path: 'javascript:void(0);', title: 'Sample 2', type: 'extLink' }
		// 	]
		// },
    {
			title: 'Products', icon: 'package', type: 'sub', badgeType: 'success', badgeValue: '4', active: true, children: [
				// { path: '/product-list', title: 'All Products', type: 'link' },
        // { path: '/product', title: 'All Products', type: 'link' },
        { path: '/category/1/Medicines', title: 'Medicines', type: 'link' },
        { path: '/category/2/healthcare', title: 'HealthCare Products', type: 'link' },
        { path: '/category/3/BabyCare', title: 'BabyCare products', type: 'link' },
        { path: '/category/4/BodyCare', title: 'BodyCare Products', type: 'link' },
			]
		},
	];
